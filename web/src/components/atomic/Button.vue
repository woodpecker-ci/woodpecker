<template>
  <button
    ...
    :class="{
      'bg-white hover:bg-gray-200 border-gray-300 dark:text-gray-300 dark:bg-dark-gray-600 dark:border-dark-400 dark:hover:bg-dark-gray-800':
        color === 'gray',
      'bg-lime-600 hover:bg-lime-700 border-lime-800 text-gray-800 dark:text-gray-300 dark:bg-lime-900 dark:hover:bg-lime-800':
        color === 'green',
