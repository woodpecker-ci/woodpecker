<template>
  <component
    ...
    v-bind="btnAttrs"
    class="relative flex shrink-0 cursor-pointer items-center overflow-hidden whitespace-nowrap rounded-md border px-2 py-1 shadow-xs transition-all duration-150 disabled:cursor-not-allowed disabled:opacity-50"
    :class="{
