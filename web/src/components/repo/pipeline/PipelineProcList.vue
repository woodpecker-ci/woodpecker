<template>
  <div class="flex flex-col w-full md:w-3/12 md:ml-2 text-gray-600 dark:text-gray-400 gap-2 pb-2">
    <div
      class="flex flex-wrap p-4 gap-1 justify-between flex-shrink-0 md:rounded-md bg-white shadow-sm dark:bg-dark-gray-700"
    >
    ...
    <div class="flex flex-grow flex-col relative min-h-0 overflow-y-auto gap-2">
      <div
        ...
        :key="proc.id"
        class="p-2 md:rounded-md bg-white shadow-sm dark:border-b-dark-gray-600 dark:bg-dark-gray-700"
      >
