<template>
  <div v-if="stats" class="flex justify-center">
    <div
      class="border-wp-background-300 dark:border-wp-background-100 bg-wp-background-200 text-wp-text-100 dark:bg-wp-background-100 w-full rounded-md border px-5 py-5"
    >
