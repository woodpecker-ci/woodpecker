  ...
  return [
    {
      ...
      perc: (props.stats.worker_count / total.value) * 100,
    ...
    },
    {
      ...
      perc: (props.stats.running_count / total.value) * 100,
    ...
    },
    {
      ...
      perc: (props.stats.pending_count / total.value) * 100,
    ...
    },
    {
      ...
      perc: (props.stats.waiting_on_deps_count / total.value) * 100,
