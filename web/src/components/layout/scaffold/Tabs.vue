<template>
  <div class="flex flex-wrap md:gap-4 mt-2">
    <router-link
      ...
      :active-class="tab.matchChildren ? '!border-wp-text-100 dark:bg-wp-background-100 bg-wp-background-200 px-2 w-auto rounded-md hover:px-2' : ''"
      :exact-active-class="tab.matchChildren ? '' : 'hover:px-2 !border-wp-text-100 md:dark:bg-wp-background-100 bg-wp-background-200 px-2 w-auto rounded-md'"
    >
      <span
