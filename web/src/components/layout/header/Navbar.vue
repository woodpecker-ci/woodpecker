<template>
  <div class="flex shadow-lg bg-lime-600 text-neutral-content px-8 py-3 dark:bg-gray-800">
    <div class="flex text-white dark:text-gray-500 items-center">
      ...
      <router-link
        v-if="user"
        :to="{ name: 'repos' }"
        class="mx-4 hover:bg-lime-700 dark:hover:bg-gray-700 px-2 rounded-md"
        >Repositories</router-link
      >
    </div>
    <div class="flex ml-auto items-center space-x-4 text-white dark:text-gray-500">
      <a :href="docsUrl" target="_blank" class="hover:bg-lime-700 dark:hover:bg-gray-700 px-2 rounded-md">Docs</a>
      <IconButton
