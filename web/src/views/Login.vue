<template>
  <main class="flex flex-col justify-center items-center w-full h-full">
    ...
    <div
      class="flex md:flex-row flex-col border-wp-background-600 bg-wp-background-200 dark:bg-wp-background-400 shadow md:m-8 border md:rounded-md w-full md:w-3xl md:h-sm overflow-hidden"
    >
