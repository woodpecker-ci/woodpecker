...
func zeroSteps(currentPipeline *model.Pipeline, remoteYamlConfigs []*remote_types.FileMeta) bool {
...
func checkIfFiltered(pipeline *model.Pipeline, remoteYamlConfigs []*remote_types.FileMeta) (bool, error) {
