...
type Store interface {
	...
	// GetUserRemoteID gets a user by remote ID.
	GetUserRemoteID(forgeID int64, remoteID model.ForgeRemoteID) (*model.User, error)
	// GetUserLogin gets a user by unique Login name.
	GetUserLogin(forgeID int64, login string) (*model.User, error)
