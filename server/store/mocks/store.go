...
// AgentListForRepo provides a mock function with given fields: repoID, opt
func (_m *Store) AgentListForRepo(repoID int64, opt *model.ListOptions) ([]*model.Agent, error) {
