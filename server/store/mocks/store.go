...
func (_m *Store) GlobalRegistryList() ([]*model.Registry, error) {
	ret := _m.Called()
...
func (_m *Store) OrgRegistryFind(_a0 string, _a1 string) (*model.Registry, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *model.Registry
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string) (*model.Registry, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(string, string) *model.Registry); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.Registry)
...
// OrgRegistryList provides a mock function with given fields: _a0
func (_m *Store) OrgRegistryList(_a0 string) ([]*model.Registry, error) {
	ret := _m.Called(_a0)
...
func (_m *Store) RegistryList(_a0 *model.Repo, _a1 bool) ([]*model.Registry, error) {
	ret := _m.Called(_a0, _a1)

	var r0 []*model.Registry
	var r1 error
	if rf, ok := ret.Get(0).(func(*model.Repo, bool) ([]*model.Registry, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(*model.Repo, bool) []*model.Registry); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*model.Registry)
