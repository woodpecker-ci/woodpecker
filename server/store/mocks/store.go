...
// WorkflowFind provides a mock function with given fields: _a0, _a1
func (_m *Store) WorkflowFind(_a0 *model.Pipeline, _a1 int) (*model.Workflow, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *model.Workflow
	var r1 error
	if rf, ok := ret.Get(0).(func(*model.Pipeline, int) (*model.Workflow, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(*model.Pipeline, int) *model.Workflow); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
