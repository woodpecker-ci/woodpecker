...
// CronExists provides a mock function for the type MockStore
func (_mock *MockStore) CronExists(repo *model.Repo, s string) (bool, error) {
	ret := _mock.Called(repo, s)

	if len(ret) == 0 {
		panic("no return value specified for CronExists")
	}

	var r0 bool
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(*model.Repo, string) (bool, error)); ok {
		return returnFunc(repo, s)
	}
	if returnFunc, ok := ret.Get(0).(func(*model.Repo, string) bool); ok {
...
// MockStore_CronExists_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CronExists'
type MockStore_CronExists_Call struct {
	*mock.Call
}

// CronExists is a helper method to define mock.On call
//   - repo *model.Repo
//   - s string
func (_e *MockStore_Expecter) CronExists(repo interface{}, s interface{}) *MockStore_CronExists_Call {
	return &MockStore_CronExists_Call{Call: _e.mock.On("CronExists", repo, s)}
}

func (_c *MockStore_CronExists_Call) Run(run func(repo *model.Repo, s string)) *MockStore_CronExists_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *model.Repo
		if args[0] != nil {
			arg0 = args[0].(*model.Repo)
...
func (_c *MockStore_CronExists_Call) Return(b bool, err error) *MockStore_CronExists_Call {
	_c.Call.Return(b, err)
	return _c
}

func (_c *MockStore_CronExists_Call) RunAndReturn(run func(repo *model.Repo, s string) (bool, error)) *MockStore_CronExists_Call {
	_c.Call.Return(run)
	return _c
}
