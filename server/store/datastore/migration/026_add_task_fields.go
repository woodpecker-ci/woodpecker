...
var addTaskFields = xormigrate.Migration{
	ID: "add-task-fields",
	MigrateSession: func(sess *xorm.Session) (err error) {
		// Add the name column to the tasks table
		_, err = sess.Exec("ALTER TABLE tasks ADD COLUMN name VARCHAR(255) NOT NULL DEFAULT '';")
		if err != nil {
			return err
		}
