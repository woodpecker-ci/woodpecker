...
ALTER TABLE ONLY public.build_config DROP CONSTRAINT build_config_config_id_fkey;
ALTER TABLE ONLY public.build_config DROP CONSTRAINT build_config_build_id_fkey;
DROP INDEX public.sender_repo_ix;
DROP INDEX public.proc_build_ix;
DROP INDEX public.ix_secrets_repo;
DROP INDEX public.ix_registry_repo;
DROP INDEX public.ix_perms_user;
DROP INDEX public.ix_perms_repo;
DROP INDEX public.ix_build_repo;
DROP INDEX public.ix_build_author;
DROP INDEX public.file_proc_ix;
DROP INDEX public.file_build_ix;
ALTER TABLE ONLY public.users DROP CONSTRAINT users_user_login_key;
ALTER TABLE ONLY public.users DROP CONSTRAINT users_pkey;
ALTER TABLE ONLY public.tasks DROP CONSTRAINT tasks_pkey;
ALTER TABLE ONLY public.senders DROP CONSTRAINT senders_sender_repo_id_sender_login_key;
ALTER TABLE ONLY public.senders DROP CONSTRAINT senders_pkey;
ALTER TABLE ONLY public.secrets DROP CONSTRAINT secrets_secret_name_secret_repo_id_key;
ALTER TABLE ONLY public.secrets DROP CONSTRAINT secrets_pkey;
ALTER TABLE ONLY public.repos DROP CONSTRAINT repos_repo_full_name_key;
ALTER TABLE ONLY public.repos DROP CONSTRAINT repos_pkey;
ALTER TABLE ONLY public.registry DROP CONSTRAINT registry_registry_addr_registry_repo_id_key;
ALTER TABLE ONLY public.registry DROP CONSTRAINT registry_pkey;
ALTER TABLE ONLY public.procs DROP CONSTRAINT procs_proc_build_id_proc_pid_key;
ALTER TABLE ONLY public.procs DROP CONSTRAINT procs_pkey;
ALTER TABLE ONLY public.perms DROP CONSTRAINT perms_perm_user_id_perm_repo_id_key;
ALTER TABLE ONLY public.migrations DROP CONSTRAINT migrations_name_key;
ALTER TABLE ONLY public.logs DROP CONSTRAINT logs_pkey;
ALTER TABLE ONLY public.logs DROP CONSTRAINT logs_log_job_id_key;
ALTER TABLE ONLY public.files DROP CONSTRAINT files_pkey;
ALTER TABLE ONLY public.files DROP CONSTRAINT files_file_proc_id_file_name_key;
ALTER TABLE ONLY public.config DROP CONSTRAINT config_pkey;
ALTER TABLE ONLY public.config DROP CONSTRAINT config_config_hash_config_repo_id_key;
ALTER TABLE ONLY public.builds DROP CONSTRAINT builds_pkey;
ALTER TABLE ONLY public.builds DROP CONSTRAINT builds_build_number_build_repo_id_key;
ALTER TABLE ONLY public.build_config DROP CONSTRAINT build_config_pkey;
ALTER TABLE ONLY public.agents DROP CONSTRAINT agents_pkey;
ALTER TABLE ONLY public.agents DROP CONSTRAINT agents_agent_addr_key;
ALTER TABLE public.users ALTER COLUMN user_id DROP DEFAULT;
ALTER TABLE public.senders ALTER COLUMN sender_id DROP DEFAULT;
ALTER TABLE public.secrets ALTER COLUMN secret_id DROP DEFAULT;
ALTER TABLE public.repos ALTER COLUMN repo_id DROP DEFAULT;
ALTER TABLE public.registry ALTER COLUMN registry_id DROP DEFAULT;
ALTER TABLE public.procs ALTER COLUMN proc_id DROP DEFAULT;
ALTER TABLE public.logs ALTER COLUMN log_id DROP DEFAULT;
ALTER TABLE public.files ALTER COLUMN file_id DROP DEFAULT;
ALTER TABLE public.config ALTER COLUMN config_id DROP DEFAULT;
ALTER TABLE public.builds ALTER COLUMN build_id DROP DEFAULT;
ALTER TABLE public.agents ALTER COLUMN agent_id DROP DEFAULT;
DROP SEQUENCE public.users_user_id_seq;
DROP TABLE public.users;
DROP TABLE public.tasks;
DROP SEQUENCE public.senders_sender_id_seq;
DROP TABLE public.senders;
DROP SEQUENCE public.secrets_secret_id_seq;
DROP TABLE public.secrets;
DROP SEQUENCE public.repos_repo_id_seq;
DROP TABLE public.repos;
DROP SEQUENCE public.registry_registry_id_seq;
DROP TABLE public.registry;
DROP SEQUENCE public.procs_proc_id_seq;
DROP TABLE public.procs;
DROP TABLE public.perms;
...
DROP SEQUENCE public.builds_build_id_seq;
DROP TABLE public.builds;
DROP TABLE public.build_config;
