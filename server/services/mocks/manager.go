...
import (
	...
	variable "go.woodpecker-ci.org/woodpecker/v2/server/services/variable"
)
...
// VariableService provides a mock function with given fields:
func (_m *Manager) VariableService() variable.Service {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for VariableService")
	}

	var r0 variable.Service
	if rf, ok := ret.Get(0).(func() variable.Service); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(variable.Service)
		}
	}
...
// VariableServiceFromRepo provides a mock function with given fields: repo
func (_m *Manager) VariableServiceFromRepo(repo *model.Repo) variable.Service {
	ret := _m.Called(repo)

	if len(ret) == 0 {
		panic("no return value specified for VariableServiceFromRepo")
	}

	var r0 variable.Service
	if rf, ok := ret.Get(0).(func(*model.Repo) variable.Service); ok {
		r0 = rf(repo)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(variable.Service)
