...
func (_m *Forge) Hook(ctx context.Context, r *http.Request) (*model.Repo, *model.Pipeline, bool, error) {
	ret := _m.Called(ctx, r)
	...
	var r2 bool
	var r3 error
	if rf, ok := ret.Get(0).(func(context.Context, *http.Request) (*model.Repo, *model.Pipeline, bool, error)); ok {
		return rf(ctx, r)
	}
	...
	if rf, ok := ret.Get(2).(func(context.Context, *http.Request) bool); ok {
		r2 = rf(ctx, r)
	} else {
		r2 = ret.Get(2).(bool)
	}
