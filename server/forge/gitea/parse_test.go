	...
	tests := []struct {
		...
		},
		{
			...
			pipe: &model.Pipeline{
				...
				PRTitleDescription: "Delete '.woodpecker/.check.yml'",
		...
		},
		{
			...
			pipe: &model.Pipeline{
				...
				Branch:             "main",
				Ref:                "refs/heads/main",
				PRTitleDescription: "add some text",
		...
		},
		{
			...
			pipe: &model.Pipeline{
				...
				PRTitleDescription: "created tag v1.0.0",
				Message:            "",
				Sender:             "gordon",
				Avatar:             "https://secure.gravatar.com/avatar/8c58a0be77ee441bb8f8595b7f1b4e87",
				Email:              "gordon@golang.org",
		...
		},
		{
			...
			pipe: &model.Pipeline{
				...
				Branch:             "main",
				Ref:                "refs/tags/0.0.5",
				PRTitleDescription: "created release Version 0.0.5",
