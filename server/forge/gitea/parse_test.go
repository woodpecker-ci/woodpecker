	...
	tests := []struct {
		...
		},
		{
			...
			pipe: &model.Pipeline{
				...
				PRContext:    "Delete '.woodpecker/.check.yml'",
		...
		},
		{
			...
			pipe: &model.Pipeline{
				...
				PRContext:         "Update the README with new information",
		...
		},
		{
			...
			pipe: &model.Pipeline{
				...
				Branch:    "main",
				Ref:       "refs/tags/0.0.5",
				PRContext: "created release Version 0.0.5",
