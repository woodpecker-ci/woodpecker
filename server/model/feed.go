...
type Feed struct {
	...
	Created  int64  `json:"created,omitempty"       xorm:"pipeline_created"`  // TODO change JSON field to "created" in 3.0
	Started  int64  `json:"started,omitempty"       xorm:"pipeline_started"`  // TODO change JSON field to "started" in 3.0
	Finished int64  `json:"finished,omitempty"      xorm:"pipeline_finished"` // TODO change JSON field to "finished" in 3.0
