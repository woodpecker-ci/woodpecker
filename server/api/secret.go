...
func GetSecret(c *gin.Context) {
	...
	secret, err := server.Config.Extensions.SecretsFromRepo(repo).SecretFind(c, repo, name)
	if err != nil {
...
func PostSecret(c *gin.Context) {
	...
	if err := server.Config.Extensions.SecretsFromRepo(repo).SecretCreate(c, repo, secret); err != nil {
...
func PatchSecret(c *gin.Context) {
	...
	if err := server.Config.Extensions.SecretsFromRepo(repo).SecretUpdate(c, repo, secret); err != nil {
...
func GetSecretList(c *gin.Context) {
	repo := session.Repo(c)
	list, err := server.Config.Extensions.SecretsFromRepo(repo).SecretList(c, repo)
	if err != nil {
...
func DeleteSecret(c *gin.Context) {
	...
	if err := server.Config.Extensions.SecretsFromRepo(repo).SecretDelete(c, repo, name); err != nil {
