...
func GetSecret(c *gin.Context) {
	...
	secret, err := server.Config.Extensions.Secrets.SecretFind(c, repo, name)
	if err != nil {
...
func PostSecret(c *gin.Context) {
	...
	if err := server.Config.Extensions.Secrets.SecretCreate(c, repo, secret); err != nil {
...
func PatchSecret(c *gin.Context) {
	...
	if err := server.Config.Extensions.Secrets.SecretUpdate(c, repo, secret); err != nil {
...
func GetSecretList(c *gin.Context) {
	repo := session.Repo(c)
	list, err := server.Config.Extensions.Secrets.SecretList(c, repo)
	if err != nil {
...
func DeleteSecret(c *gin.Context) {
	...
	if err := server.Config.Extensions.Secrets.SecretDelete(c, repo, name); err != nil {
