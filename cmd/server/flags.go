...
var flags = []cli.Flag{
	...
	&cli.BoolFlag{
		EnvVars: []string{"DRONE_KUBERNETES"},
		Name:    "kubernetes",
		Usage:   "Kubernetes backend is enabled",
	},
	&cli.StringFlag{
		EnvVars: []string{"DRONE_KUBERNETES_NAMESPACE"},
		Name:    "namespace",
		Usage:   "Kubernetes namespace to create resource in",
	},
	&cli.StringFlag{
		EnvVars: []string{"DRONE_KUBERNETES_STORAGECLASS"},
		Name:    "storageclass",
		Usage:   "Kubernetes storageclass to use for volumes",
	},
	&cli.StringFlag{
		EnvVars: []string{"DRONE_KUBERNETES_VOLUME_SIZE"},
		Name:    "volumesize",
