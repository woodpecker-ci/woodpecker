...
type WoodpeckerClient interface {
	...
	// Recovery methods for agent restart resilience
...
func (c *woodpeckerClient) UpdateStepRecoveryState(ctx context.Context, in *UpdateStepRecoveryStateRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Woodpecker_UpdateStepRecoveryState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Woodpecker_InitWorkflowRecovery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InitWorkflowRecoveryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WoodpeckerServer).InitWorkflowRecovery(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Woodpecker_InitWorkflowRecovery_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WoodpeckerServer).InitWorkflowRecovery(ctx, req.(*InitWorkflowRecoveryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Woodpecker_UpdateStepRecoveryState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(WoodpeckerServer).UpdateStepRecoveryState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Woodpecker_UpdateStepRecoveryState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WoodpeckerServer).UpdateStepRecoveryState(ctx, req.(*UpdateStepRecoveryStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Woodpecker_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Woodpecker_UpdateStepRecoveryState_Handler,
		},
	},
