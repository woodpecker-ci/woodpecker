...
const (
	...
	Woodpecker_WaitWorkflow_FullMethodName    = "/proto.Woodpecker/WaitWorkflow"
...
type WoodpeckerClient interface {
	...
	WaitWorkflow(ctx context.Context, in *WaitWorkflowRequest, opts ...grpc.CallOption) (*WaitWorkflowResponse, error)
...
func (c *woodpeckerClient) WaitWorkflow(ctx context.Context, in *WaitWorkflowRequest, opts ...grpc.CallOption) (*WaitWorkflowResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WaitWorkflowResponse)
	err := c.cc.Invoke(ctx, Woodpecker_WaitWorkflow_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WoodpeckerServer interface {
	...
	WaitWorkflow(context.Context, *WaitWorkflowRequest) (*WaitWorkflowResponse, error)
...
func (UnimplementedWoodpeckerServer) WaitWorkflow(context.Context, *WaitWorkflowRequest) (*WaitWorkflowResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method WaitWorkflow not implemented")
}
...
func _Woodpecker_WaitWorkflow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WaitWorkflowRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WoodpeckerServer).WaitWorkflow(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Woodpecker_WaitWorkflow_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WoodpeckerServer).WaitWorkflow(ctx, req.(*WaitWorkflowRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Woodpecker_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WaitWorkflow",
			Handler:    _Woodpecker_WaitWorkflow_Handler,
		},
		{
			MethodName: "Done",
