...
type WaitWorkflowRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                         // ID of the workflow owned by the calling agent
	WorkflowName  string                 `protobuf:"bytes,2,opt,name=workflow_name,json=workflowName,proto3" json:"workflow_name,omitempty"` // name of the target workflow within the same pipeline
	StepName      string                 `protobuf:"bytes,3,opt,name=step_name,json=stepName,proto3" json:"step_name,omitempty"`             // optional: a specific step of the target workflow
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *WaitWorkflowRequest) Reset() {
	*x = WaitWorkflowRequest{}
	mi := &file_woodpecker_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *WaitWorkflowRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WaitWorkflowRequest) ProtoMessage() {}

func (x *WaitWorkflowRequest) ProtoReflect() protoreflect.Message {
	mi := &file_woodpecker_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WaitWorkflowRequest.ProtoReflect.Descriptor instead.
func (*WaitWorkflowRequest) Descriptor() ([]byte, []int) {
	return file_woodpecker_proto_rawDescGZIP(), []int{8}
}

func (x *WaitWorkflowRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *WaitWorkflowRequest) GetWorkflowName() string {
	if x != nil {
...
func (x *WaitWorkflowRequest) GetStepName() string {
	if x != nil {
		return x.StepName
	}
	return ""
...
type WaitWorkflowResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Found         bool                   `protobuf:"varint,1,opt,name=found,proto3" json:"found,omitempty"`  // false: no matching workflow (or step) exists in the pipeline
	Status        string                 `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"` // terminal status when found; empty = not terminal yet, poll again
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *WaitWorkflowResponse) Reset() {
	*x = WaitWorkflowResponse{}
	mi := &file_woodpecker_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *WaitWorkflowResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WaitWorkflowResponse) ProtoMessage() {}

func (x *WaitWorkflowResponse) ProtoReflect() protoreflect.Message {
	mi := &file_woodpecker_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WaitWorkflowResponse.ProtoReflect.Descriptor instead.
func (*WaitWorkflowResponse) Descriptor() ([]byte, []int) {
	return file_woodpecker_proto_rawDescGZIP(), []int{21}
}

func (x *WaitWorkflowResponse) GetFound() bool {
	if x != nil {
		return x.Found
	}
	return false
...
func (x *WaitWorkflowResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
const file_woodpecker_proto_rawDesc = "" +
	...
	"\x13WaitWorkflowRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12#\n" +
	"\rworkflow_name\x18\x02 \x01(\tR\fworkflowName\x12\x1b\n" +
	"\tstep_name\x18\x03 \x01(\tR\bstepName\"I\n" +
	...
	"\bcanceled\x18\x01 \x01(\bR\bcanceled\"D\n" +
	"\x14WaitWorkflowResponse\x12\x14\n" +
	...
	"\faccess_token\x18\x03 \x01(\tR\vaccessToken2\x8d\x05\n" +
	"\n" +
	"Woodpecker\x121\n" +
	...
	"\x04Wait\x12\x12.proto.WaitRequest\x1a\x13.proto.WaitResponse\"\x00\x12I\n" +
	"\fWaitWorkflow\x12\x1a.proto.WaitWorkflowRequest\x1a\x1b.proto.WaitWorkflowResponse\"\x00\x12*\n" +
...
var file_woodpecker_proto_goTypes = []any{
	...
	(*WaitWorkflowRequest)(nil),   // 8: proto.WaitWorkflowRequest
	...
	(*WaitWorkflowResponse)(nil),  // 21: proto.WaitWorkflowResponse
...
var file_woodpecker_proto_depIdxs = []int32{
	...
	25, // 6: proto.AgentInfo.customLabels:type_name -> proto.AgentInfo.CustomLabelsEntry
	...
	8,  // 13: proto.Woodpecker.WaitWorkflow:input_type -> proto.WaitWorkflowRequest
	9,  // 14: proto.Woodpecker.Done:input_type -> proto.DoneRequest
	10, // 15: proto.Woodpecker.Extend:input_type -> proto.ExtendRequest
	11, // 16: proto.Woodpecker.Update:input_type -> proto.UpdateRequest
	12, // 17: proto.Woodpecker.Log:input_type -> proto.LogRequest
	16, // 18: proto.Woodpecker.RegisterAgent:input_type -> proto.RegisterAgentRequest
	13, // 19: proto.Woodpecker.UnregisterAgent:input_type -> proto.Empty
	14, // 20: proto.Woodpecker.ReportHealth:input_type -> proto.ReportHealthRequest
	22, // 21: proto.WoodpeckerAuth.Auth:input_type -> proto.AuthRequest
	17, // 22: proto.Woodpecker.Version:output_type -> proto.VersionResponse
	18, // 23: proto.Woodpecker.Next:output_type -> proto.NextResponse
	13, // 24: proto.Woodpecker.Init:output_type -> proto.Empty
	20, // 25: proto.Woodpecker.Wait:output_type -> proto.WaitResponse
	21, // 26: proto.Woodpecker.WaitWorkflow:output_type -> proto.WaitWorkflowResponse
	13, // 27: proto.Woodpecker.Done:output_type -> proto.Empty
	13, // 28: proto.Woodpecker.Extend:output_type -> proto.Empty
	13, // 29: proto.Woodpecker.Update:output_type -> proto.Empty
	13, // 30: proto.Woodpecker.Log:output_type -> proto.Empty
	19, // 31: proto.Woodpecker.RegisterAgent:output_type -> proto.RegisterAgentResponse
	13, // 32: proto.Woodpecker.UnregisterAgent:output_type -> proto.Empty
	13, // 33: proto.Woodpecker.ReportHealth:output_type -> proto.Empty
