...
const (
	RecoveryStatus_RECOVERY_PENDING RecoveryStatus = 0
	RecoveryStatus_RECOVERY_RUNNING RecoveryStatus = 1
	RecoveryStatus_RECOVERY_SUCCESS RecoveryStatus = 2
	RecoveryStatus_RECOVERY_FAILED  RecoveryStatus = 3
	RecoveryStatus_RECOVERY_SKIPPED RecoveryStatus = 4
)
...
type InitWorkflowRecoveryRequest struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	WorkflowId     string                 `protobuf:"bytes,1,opt,name=workflow_id,json=workflowId,proto3" json:"workflow_id,omitempty"`
	StepUuids      []string               `protobuf:"bytes,2,rep,name=step_uuids,json=stepUuids,proto3" json:"step_uuids,omitempty"`
...
func (x *InitWorkflowRecoveryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *InitWorkflowRecoveryRequest) GetStepUuids() []string {
	if x != nil {
		return x.StepUuids
	}
	return nil
...
func (x *InitWorkflowRecoveryRequest) GetTimeoutSeconds() int64 {
	if x != nil {
...
type StepRecoveryState struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	StepUuid      string                 `protobuf:"bytes,1,opt,name=step_uuid,json=stepUuid,proto3" json:"step_uuid,omitempty"`
	Status        RecoveryStatus         `protobuf:"varint,2,opt,name=status,proto3,enum=proto.RecoveryStatus" json:"status,omitempty"`
...
func (x *StepRecoveryState) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *StepRecoveryState) GetStatus() RecoveryStatus {
	if x != nil {
		return x.Status
	}
	return RecoveryStatus_RECOVERY_PENDING
}

func (x *StepRecoveryState) GetExitCode() int32 {
	if x != nil {
		return x.ExitCode
	}
	return 0
...
type UpdateStepRecoveryStateRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	WorkflowId    string                 `protobuf:"bytes,1,opt,name=workflow_id,json=workflowId,proto3" json:"workflow_id,omitempty"`
	StepUuid      string                 `protobuf:"bytes,2,opt,name=step_uuid,json=stepUuid,proto3" json:"step_uuid,omitempty"`
	Status        RecoveryStatus         `protobuf:"varint,3,opt,name=status,proto3,enum=proto.RecoveryStatus" json:"status,omitempty"`
...
func (x *UpdateStepRecoveryStateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *UpdateStepRecoveryStateRequest) GetStepUuid() string {
	if x != nil {
		return x.StepUuid
	}
	return ""
...
func (x *UpdateStepRecoveryStateRequest) GetStatus() RecoveryStatus {
	if x != nil {
		return x.Status
	}
	return RecoveryStatus_RECOVERY_PENDING
...
func (x *UpdateStepRecoveryStateRequest) GetExitCode() int32 {
	if x != nil {
		return x.ExitCode
	}
	return 0
...
const file_woodpecker_proto_rawDesc = "" +
	...
	"\x10RECOVERY_SKIPPED\x10\x042\xcb\x06\n" +
	"\n" +
	"Woodpecker\x121\n" +
...
var file_woodpecker_proto_goTypes = []any{
	...
	(*InitWorkflowRecoveryRequest)(nil),       // 22: proto.InitWorkflowRecoveryRequest
	(*GetWorkflowRecoveryStatesRequest)(nil),  // 23: proto.GetWorkflowRecoveryStatesRequest
	(*StepRecoveryState)(nil),                 // 24: proto.StepRecoveryState
	(*GetWorkflowRecoveryStatesResponse)(nil), // 25: proto.GetWorkflowRecoveryStatesResponse
...
var file_woodpecker_proto_depIdxs = []int32{
	...
	24, // 10: proto.GetWorkflowRecoveryStatesResponse.states:type_name -> proto.StepRecoveryState
	...
	22, // 23: proto.Woodpecker.InitWorkflowRecovery:input_type -> proto.InitWorkflowRecoveryRequest
	23, // 24: proto.Woodpecker.GetWorkflowRecoveryStates:input_type -> proto.GetWorkflowRecoveryStatesRequest
	26, // 25: proto.Woodpecker.UpdateStepRecoveryState:input_type -> proto.UpdateStepRecoveryStateRequest
	20, // 26: proto.WoodpeckerAuth.Auth:input_type -> proto.AuthRequest
	...
	13, // 30: proto.Woodpecker.Wait:output_type -> proto.Empty
	...
	25, // 39: proto.Woodpecker.GetWorkflowRecoveryStates:output_type -> proto.GetWorkflowRecoveryStatesResponse
	13, // 40: proto.Woodpecker.UpdateStepRecoveryState:output_type -> proto.Empty
	21, // 41: proto.WoodpeckerAuth.Auth:output_type -> proto.AuthResponse
