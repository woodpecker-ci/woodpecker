...
const (
	...
	Woodpecker_Log_FullMethodName             = "/proto.Woodpecker/EnqueueLog"
...
func (UnimplementedWoodpeckerServer) Log(context.Context, *LogRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EnqueueLog not implemented")
}
