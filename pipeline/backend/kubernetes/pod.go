...
func podContainer(step *types.Step, podName, goos string, config *config, options BackendOptions, nsp nativeSecretsProcessor) (v1.Container, error) {
	var err error
...
func mergePodSecurityContext(target *v1.PodSecurityContext, mergeFrom SecurityContext) {
...
func podSecurityContext(sc *SecurityContext, config *config, stepPrivileged bool) *v1.PodSecurityContext {
...
func containerSecurityContext(sc *SecurityContext, config *config, stepPrivileged bool) *v1.SecurityContext {
	var (
		privileged               *bool
