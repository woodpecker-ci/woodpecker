	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedEnviron: map[string]string{
				...
				"CI_PREV_PIPELINE_STARTED": "0", "CI_PREV_PIPELINE_STATUS": "", "CI_PREV_PIPELINE_URL": "", "CI_REPO": "", "CI_REPO_CLONE_URL": "", "CI_REPO_CLONE_URL_SSH": "", "CI_REPO_DEFAULT_BRANCH": "", "CI_REPO_REMOTE_ID": "",
		...
		},
		{
			...
			expectedMetadata: metadata.Metadata{
				...
				Repo:     metadata.Repo{Owner: "testUser", Name: "testRepo", Link: "https://gitea.com/testUser/testRepo", CloneURL: "https://gitea.com/testUser/testRepo.git", CloneURLSSH: "git@gitea.com:testUser/testRepo.git", Branch: "main", Private: true},
			...
			expectedEnviron: map[string]string{
				...
				"CI_PREV_PIPELINE_STARTED": "0", "CI_PREV_PIPELINE_STATUS": "", "CI_PREV_PIPELINE_URL": "", "CI_REPO": "testUser/testRepo", "CI_REPO_CLONE_URL": "https://gitea.com/testUser/testRepo.git", "CI_REPO_CLONE_URL_SSH": "git@gitea.com:testUser/testRepo.git",
