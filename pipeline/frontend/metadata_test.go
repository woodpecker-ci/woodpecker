	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedEnviron: map[string]string{
				...
				"CI_STEP_NAME": "", "CI_STEP_NUMBER": "0", "CI_STEP_STARTED": "", "CI_STEP_STATUS": "", "CI_SYSTEM_ARCH": "", "CI_SYSTEM_HOST": "", "CI_SYSTEM_NAME": "woodpecker",
		...
		},
		{
			...
			expectedEnviron: map[string]string{
				...
				"CI_STEP_NAME": "", "CI_STEP_NUMBER": "0", "CI_STEP_STARTED": "", "CI_STEP_STATUS": "", "CI_SYSTEM_ARCH": "", "CI_SYSTEM_HOST": "example.com",
