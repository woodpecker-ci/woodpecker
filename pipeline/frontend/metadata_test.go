...
func TestMetadataFromStruct(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedEnviron: map[string]string{
				"CI": "woodpecker", "CI_BUILD_CREATED": "0", "CI_BUILD_FINISHED": "0",
				"CI_BUILD_STARTED": "0", "CI_COMMIT_AUTHOR": "", "CI_COMMIT_AUTHOR_AVATAR": "", "CI_COMMIT_AUTHOR_EMAIL": "", "CI_COMMIT_BRANCH": "", "CI_COMMIT_LINK": "",
