...
var files = map[string]file{
	"/static/vendor.54155ecaab021ce4f803.js": {
		data: file0,
		FileInfo: &fileInfo{
			name:    "vendor.54155ecaab021ce4f803.js",
			size:    272283,
			modTime: time.Unix(1558947778, 0),
		},
	},
	"/static/bundle.5f1419bc1bce06e2bb89.js": {
		data: file1,
		FileInfo: &fileInfo{
			name:    "bundle.5f1419bc1bce06e2bb89.js",
			size:    372621,
			modTime: time.Unix(1558947778, 0),
		},
	},
...
var _reactTimeago = __webpack_require__(191);
...
var _breadcrumb = __webpack_require__(527);
...
var _feed = __webpack_require__(189);

var _reactRouterDom = __webpack_require__(30);

var _drone = __webpack_require__(585);
...
var _builds = __webpack_require__(506);

var _builds2 = _interopRequireDefault(_builds);

var _repos = __webpack_require__(519);

var _repos2 = _interopRequireDefault(_repos);

var _tokens = __webpack_require__(531);
...
var _header = __webpack_require__(538);

var _header2 = _interopRequireDefault(_header);

var _menu3 = __webpack_require__(539);
...
var _menu5 = __webpack_require__(567);

var _menu6 = _interopRequireDefault(_menu5);

var _menu7 = __webpack_require__(129);

var _menu8 = _interopRequireDefault(_menu7);

var _snackbar = __webpack_require__(568);
	...
	function Sidebar(props, context) {
		...
		_this.renderItem = function (item, renderStarred) {
			...
			return _react2["default"].createElement(
				...
				_react2["default"].createElement(_components.Item, { item: item, onFave: _this.onFave, faved: starred.includes(item.full_name) })
			);
		};

		_this.onFave = function (full_name) {
			if (!_this.state.starred.includes(full_name)) {
				_this.setState(function (state) {
					var list = state.starred.concat(full_name);
					return { starred: list };
				});
			} else {
				_this.setState(function (state) {
	...
	Sidebar.prototype.render = function render() {
		...
		return _react2["default"].createElement(
			...
			_react2["default"].createElement(
				...
				{ trigger: "Starred", triggerTagName: "div", transitionTime: 200, open: starredOpen, onOpen: this.toggleStarred, onClose: this.toggleStarred, triggerOpenedClassName: _index2["default"].Collapsible__trigger, triggerClassName: _index2["default"].Collapsible__trigger },
				feed.loaded === false ? LOADING : feed.error ? ERROR : list.length === 0 ? EMPTY : this.renderFeed(list, true)
			),
			_react2["default"].createElement(
				_reactCollapsible2["default"],
				{ trigger: "Repos", triggerTagName: "div", transitionTime: 200, open: reposOpen, onOpen: this.toggleAll, onClose: this.toggleAll, triggerOpenedClassName: _index2["default"].Collapsible__trigger, triggerClassName: _index2["default"].Collapsible__trigger },
				_react2["default"].createElement("input", {
					type: "text",
					placeholder: "Search \u2026",
...
var _humanizeDuration = __webpack_require__(192);
...
var _components = __webpack_require__(493);
...
var _form = __webpack_require__(495);
...
var _visibility = __webpack_require__(503);
...
var _components = __webpack_require__(507);
...
var _list = __webpack_require__(508);
...
var _status_number = __webpack_require__(194);
...
var _components = __webpack_require__(520);
...
var _switch = __webpack_require__(522);

var _list = __webpack_require__(525);
...
var _switch = __webpack_require__(523);
...
var _users = __webpack_require__(532);
...
var _sync = __webpack_require__(536);
...
var _logs = __webpack_require__(555);
...
var _matrix = __webpack_require__(548);
...
var _matrix = __webpack_require__(549);
...
// module
exports.push([module.i, ".matrix__list___3fXXJ a {\n  border-bottom: 1px solid #eceff1;\n  color: #212121;\n  cursor: pointer;\n  display: block;\n  padding: 20px 10px;\n  text-decoration: none;\n}\n.matrix__list___3fXXJ a:hover {\n  background: #eceff1;\n}\n.matrix__list___3fXXJ a:hover .matrix__body___3IR3N {\n  border-color: #bdbdbd;\n}\n.matrix__list___3fXXJ a:first-of-type {\n  padding-top: 10px;\n}\n.matrix__list___3fXXJ a:last-of-type {\n  border-bottom: 0px;\n}\n.matrix__item___1YrdP {\n  display: flex;\n  flex-direction: row;\n}\n.matrix__header___3KfXx {\n  flex: 1;\n}\n.matrix__header___3KfXx div {\n  font-family: 'Roboto Mono';\n  font-size: 14px;\n  line-height: 26px;\n}\n.matrix__body___3IR3N {\n  border-left: 1px solid #eceff1;\n  flex: 0 0 200px;\n  padding-left: 20px;\n}\n.matrix__status___1gr0C {\n  align-items: right;\n  display: flex;\n  padding-left: 20px;\n}\n.matrix__status___1gr0C > :last-child {\n  margin-left: 20px;\n}\n", ""]);

// exports
exports.locals = {
	"list": "matrix__list___3fXXJ",
	"body": "matrix__body___3IR3N",
	"item": "matrix__item___1YrdP",
	"header": "matrix__header___3KfXx",
	"status": "matrix__status___1gr0C"
};
...
var _elapsed = __webpack_require__(552);

var _procs = __webpack_require__(553);
...
var _logs = __webpack_require__(556);

var _term = __webpack_require__(557);

var _term2 = _interopRequireDefault(_term);

var _anchor = __webpack_require__(560);

var _index = __webpack_require__(40);

var _index2 = __webpack_require__(563);
...
var _term = __webpack_require__(558);
...
var _anchor = __webpack_require__(561);
...
var _drawer = __webpack_require__(581);
...
<body>
<script type="text/javascript" src="/static/vendor.54155ecaab021ce4f803.js"></script><script type="text/javascript" src="/static/bundle.5f1419bc1bce06e2bb89.js"></script></body>
</html>
`)
