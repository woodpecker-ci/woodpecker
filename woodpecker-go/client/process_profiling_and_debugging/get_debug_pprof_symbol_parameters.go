...
GetDebugPprofSymbolParams contains all the parameters to send to the API endpoint
	...
	for the get debug pprof symbol operation.
...
// WithDefaults hydrates default values in the get debug pprof symbol params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDebugPprofSymbolParams) WithDefaults() *GetDebugPprofSymbolParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get debug pprof symbol params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDebugPprofSymbolParams) SetDefaults() {
	var (
		authorizationDefault = string("Bearer <personal access token>")
	)

	val := GetDebugPprofSymbolParams{
...
// WithAuthorization adds the authorization to the get debug pprof symbol params
func (o *GetDebugPprofSymbolParams) WithAuthorization(authorization string) *GetDebugPprofSymbolParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the get debug pprof symbol params
func (o *GetDebugPprofSymbolParams) SetAuthorization(authorization string) {
