...
import IconStatusDeclined from 'virtual:vite-icons/ph/hand.vue';
import IconStatusError from 'virtual:vite-icons/ph/x-circle.vue';
import IconStatusFailure from 'virtual:vite-icons/ph/warning.vue';
import IconStatusKilled from 'virtual:vite-icons/ph/x-circle.vue';
import IconStatusPending from 'virtual:vite-icons/ph/hourglass.vue';
import IconStatusRunning from 'virtual:vite-icons/entypo/dots-two-vertical.vue';
import IconStatusSkipped from 'virtual:vite-icons/ph/prohibit.vue';
import IconStatusStarted from 'virtual:vite-icons/entypo/dots-two-vertical.vue';
import IconStatusSuccess from 'virtual:vite-icons/ph/check-circle.vue';
