...
>
> You can add more agents to increase the number of parallel builds or set the agent's `WOODPECKER_MAX_STEPS=1` environment variable to increase the number of parallel builds for that agent.
