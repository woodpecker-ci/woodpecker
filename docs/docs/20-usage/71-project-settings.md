...
As the owner of a project in Woodpecker you can change project related settings via the Webinterface.
...
Your Version-Control-System will notify Woodpecker about events via webhooks. If you want your pipeline to only run on specific webhooks, you can check them by this setting.
