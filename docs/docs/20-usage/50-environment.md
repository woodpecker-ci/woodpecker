...
| `CI_AGENT_LABELS`                  | `runtime`         | labels of the agent running the step, as a JSON object with keys sorted                                                                          | `{"backend":"docker","hostname":"agent-1","platform":"linux/amd64","repo":"*"}`                                                 |
|                                    |                   | **Forge**                                                                                                                                        |                                                                                                                                 |
