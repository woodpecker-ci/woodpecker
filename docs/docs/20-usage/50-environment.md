...
|                                    |                   | **Agent**                                                                                                                                        |                                                                                                                                 |
| `CI_AGENT_ID`                      | `runtime`         | ID of the agent running the step                                                                                                                 | `3`                                                                                                                             |
| `CI_AGENT_LABELS`                  | `runtime`         | labels of the agent running the step, as a comma-separated list of `key=value` pairs sorted by key                                               | `backend=docker,hostname=agent-1,platform=linux/amd64,repo=*`                                                                   |
|                                    |                   | **Forge**                                                                                                                                        |                                                                                                                                 |
