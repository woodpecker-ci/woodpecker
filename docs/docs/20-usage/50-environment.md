...
| `CI_COMMIT_PULL_REQUEST_DRAFT`     | whether the pull request is a draft (set only for pull request events; see [forge support](#cicommit_pull_request_draft-forge-support))        | `true`, `false`                                                                                            |
