...
**--plugins-trusted-clone**="": plugins that are trusted to handle Git credentials in cloning steps (default: "docker.io/woodpeckerci/plugin-git:2.9.1", "docker.io/woodpeckerci/plugin-git", "quay.io/woodpeckerci/plugin-git")
