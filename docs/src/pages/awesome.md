...
- [woodpecker-shellcheck](https://forge.colobox.com/rfinnie/woodpecker-shellcheck) - A pre-commit hook which runs workflow steps' commands through [shellcheck](https://www.shellcheck.net/) lint.
